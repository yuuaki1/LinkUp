            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-12">
                    <div className="border-b border-gray-700 pb-12">
                        <h2 className="text-base font-semibold text-gray-100 leading-7">
                            Create a group chat
                        </h2>
                        <p className="mt-1 text-sm leading-6 text-gray-400">
                            Group chat with your friends and family
                        </p>
                        <div className="mt-10 flex flex-col gap-y-8">
                            <Input id = "name" register={register} label = "name" disabled = {isLoading} required errors={errors}/>
